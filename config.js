    ...
    createDefaultConfig() {
        const defaultConfig = {
            ...
            settings: {
                ...
                ANTIDELETE_RECOVER_CONVENTION: process.env.ANTIDELETE_RECOVER_CONVENTION || 'yes',
...
module.exports = {
    ...
    get ANTIDELETE1() { return hybridConfig.getSetting('ANTIDELETE_RECOVER_CONVENTION', 'yes'); },
    ...
    get AUTO_REACT() { return hybridConfig.getSetting('AUTO_REACT', 'yes'); },
